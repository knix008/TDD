...
namespace rlog
{
    ...
    RLOG_DECL RLogChannel *GetComponentChannel(const char *component, const char *path, LogLevel level) { return 0; }
    RLOG_DECL RLogChannel *GetGlobalChannel(const char *path, LogLevel level) { return 0; }
